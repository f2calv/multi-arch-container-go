...
kubectl run -i --tty --attach multi-arch-container-go --image=ghcr.io/f2calv/multi-arch-container-go --image-pull-policy='Always'
kubectl logs -f multi-arch-container-go
#kubectl delete po multi-arch-container-go
```
